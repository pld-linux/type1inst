...
%description -l pl
type1inst jest programem, który skanuje pliki czcionek PostScript Type 1 
i tworzy plik fonts.scale i/lub plik Fontmap na u¿ytek X Window System 
i Ghostscript. Potrafi równie¿ wygenerowaæ proste przyk³ady zainstalowanych
czcionek.

type1inst jest skryptem Perla, wiêc musisz mieæ go zainstalowanego je¶li
chcesz u¿ywaæ type1inst. Wymagane jest równie¿ narzêdzie pfbtops 
